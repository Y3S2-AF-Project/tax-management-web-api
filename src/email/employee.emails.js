...
export const sendGeneratedPassord = async (employeeObj, autoGeneratedPassword) => {
  ...
  const email = {
    body: {
      ...
      intro: `You have been added as an ${employeeObj.role} to the Tax Management System. We have generated a temporary password for you to access your admin profile.`,
      action: {
  ...
  await mailTransporter
    .sendMail(details)
    .then(() => {
      logger.info(`Email sent to ${employeeObj.email}`)
    })
    .catch((error) => {
